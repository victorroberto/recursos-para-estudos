...
**Learn Data Science** | [Dataquest](https://www.dataquest.io/?utm_source=learndatasci) | `Data Science` | `Inglês` | Obtenha as habilidades que você precisa para conseguir seu primeiro trabalho de ciência de dados. Aprenda R, Python e SQL, sem necessidade de experiência!
...
**Data Science - *IBM*** | [IBM](https://www.coursera.org/professional-certificates/ibm-data-science) | `Data Science` | `Inglês` | Ciência de dados, Python & SQL, analise e visualize dados, crie modelos de aprendizado de máquina.
**Nanocursos - Movimento Brasil Digital**| [FIAP](https://on.fiap.com.br/local/movimentobrasildigital/) | `Python`, `BI`, `IA`, `Devops`, `Blockchain` | `Português` | 10 Nano Courses de 40 a 160 horas, nas áreas de tecnologia, inovação e negócios.
**Deep Learning - *New York University*** | [Atcold](https://atcold.github.io/pytorch-Deep-Learning/) | `Deep Learning` | `Inglês` | Técnicas de aprendizagem profunda, com foco em aprendizagem supervisionada e não supervisionada, redes convolucionais e recorrentes, visão computacional, linguagem natural e fala.
**Cursos IBM Skills Network Labs** | [cognitiveclass](https://labs.cognitiveclass.ai/) | `Machine Learning`, `IA`, `Python`, `Spark`| `Inglês` | O IBM Skills Network Labs é um lugar para você praticar as habilidades de ciência de dados, aprendizado de máquina e IA.
